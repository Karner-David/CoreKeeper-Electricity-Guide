...
export default function CreateNewItem() {
    ...
    async function submitNewItem() {
      const input = {
        name: "Conveyor Belt",
    desc: "A Conveyor Belt moves items toward its facing direction and doesn’t require electricity.",
    descLonger:
      "Belts are essential for large-scale automation setups, transporting items quickly.",
    img: "/item-thumbnails/conveyor_belt.webp",
    materials: ["2 Tin Bar"],
    materialImg: ["/item-thumbnails/tin_bar.webp"],
    station: "Automation Table",
    stationImg: "/item-thumbnails/automation_table.webp",
    howToUse:
      "Lay belts end-to-end; dropped items will travel along the belt path automatically.",
    ...
    return (
      <div>
        <button style={{background: "white"}} onClick={submitNewItem}>Upload Item</button>
      </div>
    )
}
